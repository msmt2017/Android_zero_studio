...
public /*final*/ class TermuxActivity extends Activity implements ServiceConnection {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        content.setOnApplyWindowInsetsListener(new OnApplyWindowInsetsListener() {
	...
	protected void onNewIntent(final Intent intent) {
		if (intent != null && !intent.equals(lastIntent) && intent.hasExtra(work_dir_extra)) {
			handlerGradleCmdLine(intent);			
		}
		super.onNewIntent(this.lastIntent = intent);
	}

	private void handlerGradleCmdLine(final Intent intent) {
		//接收传入的命令并异步运行
    ...
    public void onServiceConnected(ComponentName componentName, IBinder service) {
        ...
        if (mTermuxService.isTermuxSessionsEmpty()) {
            if (mIsVisible) {
                TermuxInstaller.setupBootstrapIfNeeded(TermuxActivity.this, new Runnable() {
    ...
    private void setTerminalToolbarHeight() {
        ...
        if (terminalToolbarViewPager == null)
            return;
        ViewGroup.LayoutParams layoutParams = terminalToolbarViewPager.getLayoutParams();
        layoutParams.height = Math.round(mTerminalToolbarDefaultHeight * (mProperties.getExtraKeysInfo() == null ? 0 : mProperties.getExtraKeysInfo().getMatrix().length) * mProperties.getTerminalToolbarHeightScaleFactor());
    ...
    private void setSettingsButtonView() {
        ...
        settingsButton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					startActivity(new Intent(TermuxActivity.this, SettingsActivity.class));
				}
			});
    }
    ...
    private void setNewSessionButtonView() {
        ...
        newSessionButton.setOnLongClickListener(new OnLongClickListener() {
				...
				public boolean onLongClick(View v) {
					TextInputDialogUtils.textInput(TermuxActivity.this, R.string.title_create_named_session, null, R.string.action_create_named_session_confirm, new TextSetListener() {

							@Override
							public void onTextSet(String text) {
								mTermuxTerminalSessionClient.addNewSession(false, text);
							}
						}, R.string.action_new_session_failsafe, new TextSetListener() {

							@Override
							public void onTextSet(String text) {
								mTermuxTerminalSessionClient.addNewSession(true, text);
							}
						}, -1, null, null);
					return true;
				}
    ...
    private void showKillSessionDialog(final TerminalSession session) {
        if (session == null)
            return;
        final AlertDialog.Builder b = new AlertDialog.Builder(this);
        b.setIcon(android.R.drawable.ic_dialog_alert);
        b.setMessage(R.string.title_confirm_kill_process);
        b.setPositiveButton(android.R.string.yes, new android.content.DialogInterface.OnClickListener() {
    ...
    private void showStylingDialog() {
        ...
        try {
            ...
            new AlertDialog.Builder(this).setMessage(getString(R.string.error_styling_not_installed)).setPositiveButton(R.string.action_styling_install, new android.content.DialogInterface.OnClickListener() {
